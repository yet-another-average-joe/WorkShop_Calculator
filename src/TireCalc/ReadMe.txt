================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet TireCalc
===============================================================================

L'Assistant Application a créé cette application TireCalc pour  
...
constituent votre application TireCalc.
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CTireCalcApp.

TireCalc.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CTireCalcApp.
...
TireCalcDlg.h, TireCalcDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CTireCalcDlg.  Cette classe 
définit 
...
(PCH) 
    nommé TireCalc.pch et un fichier de types précompilés nommé 
StdAfx.obj.
