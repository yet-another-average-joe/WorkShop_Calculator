================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet ThunderCalc
===============================================================================

L'Assistant Application a créé cette application ThunderCalc pour  
...
constituent votre application ThunderCalc.
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CThunderCalcApp.

ThunderCalc.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CThunderCalcApp.
...
ThunderCalcDlg.h, ThunderCalcDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CThunderCalcDlg.  Cette classe 
définit 
...
(PCH) 
    nommé ThunderCalc.pch et un fichier de types précompilés nommé 
StdAfx.obj.
