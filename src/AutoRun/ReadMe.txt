================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet AutoRun
===============================================================================

L'Assistant Application a créé cette application AutoRun pour  
...
constituent votre application AutoRun.
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CAutoRunApp.

AutoRun.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CAutoRunApp.
...
AutoRunDlg.h, AutoRunDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CAutoRunDlg.  Cette classe 
définit 
...
(PCH) 
    nommé AutoRun.pch et un fichier de types précompilés nommé 
StdAfx.obj.
