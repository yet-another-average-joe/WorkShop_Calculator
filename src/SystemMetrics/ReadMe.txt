================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet SystemMetrics
===============================================================================

L'Assistant Application a créé cette application SystemMetrics pour  
...
constituent votre application SystemMetrics.
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CSystemMetricsApp.

SystemMetrics.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CSystemMetricsApp.
...
SystemMetricsDlg.h, SystemMetricsDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CSystemMetricsDlg.  Cette classe 
définit 
...
(PCH) 
    nommé SystemMetrics.pch et un fichier de types précompilés nommé 
StdAfx.obj.
