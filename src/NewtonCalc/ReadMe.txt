================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet NewtonCalc
===============================================================================

L'Assistant Application a créé cette application NewtonCalc pour  
...
constituent votre application NewtonCalc.
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CNewtonCalcApp.

NewtonCalc.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CNewtonCalcApp.
...
NewtonCalcDlg.h, NewtonCalcDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CNewtonCalcDlg.  Cette classe 
définit 
...
(PCH) 
    nommé NewtonCalc.pch et un fichier de types précompilés nommé 
StdAfx.obj.
