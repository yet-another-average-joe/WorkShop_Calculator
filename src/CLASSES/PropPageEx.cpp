// CEScrollPropPage.cpp : fichier d'implémentation
//
...
// taille idélae pour ne pas avoir de barres de scrolling = 150x149
// ça laisse une marge à droite qui évite de voir apparaitre une barre 
// de scrolling horizontale dès qu'une verticale est nécessaire


// IMPORTANT : GetScrollInfo() / SetScrollInfo() doit être utilisé avec SIF_ALL
...
void CPropPageEx::Init()
{
	...
	m_fEnableScrollbars = FALSE; // scrolling par défaut
	m_fDoneDDE = FALSE;
}
