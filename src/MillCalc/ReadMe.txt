================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet MillCalc
===============================================================================

L'Assistant Application a créé cette application MillCalc pour  
...
constituent votre application MillCalc.
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CMillCalcApp.

MillCalc.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CMillCalcApp.
...
SheetMillCalc.h, SheetMillCalc.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CSheetMillCalc.  Cette classe 
définit 
...
(PCH) 
    nommé MillCalc.pch et un fichier de types précompilés nommé 
StdAfx.obj.
