================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet WrkShpCalc
===============================================================================

L'Assistant Application a créé cette application WrkShpCalc pour  
...
constituent votre application WrkShpCalc.
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CWrkShpCalcApp.

WrkShpCalc.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CWrkShpCalcApp.
...
WrkShpCalcDlg.h, WrkShpCalcDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CWrkShpCalcDlg.  Cette classe 
définit 
...
(PCH) 
    nommé WrkShpCalc.pch et un fichier de types précompilés nommé 
StdAfx.obj.
