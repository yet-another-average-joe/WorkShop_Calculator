================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet SysColor
===============================================================================

L'Assistant Application a créé cette application SysColor pour  
...
constituent votre application SysColor.
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CSysColorApp.

SysColor.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CSysColorApp.
...
SysColorDlg.h, SysColorDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CSysColorDlg.  Cette classe 
définit 
...
(PCH) 
    nommé SysColor.pch et un fichier de types précompilés nommé 
StdAfx.obj.
