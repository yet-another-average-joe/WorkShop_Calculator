================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet ParserCalc
===============================================================================

L'Assistant Application a créé cette application ParserCalc pour  
...
constituent votre application ParserCalc.
...
d'autres 
    en-têtes de projet spécifiques et déclare la classe d'application CParserCalcApp.

ParserCalc.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CParserCalcApp.
...
ParserCalcDlg.h, ParserCalcDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CParserCalcDlg.  Cette classe 
définit 
...
(PCH) 
    nommé ParserCalc.pch et un fichier de types précompilés nommé 
StdAfx.obj.
